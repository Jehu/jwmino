 ...
 *ngMobile Module
 */
var ngMobile = angular.module('ngMobile', ['SharedServices', 'jehu.i18n', 'database']);
  ...
  return {
    ...
    compile: function compile(tElement, tAttrs, transclude) {
      return function postLink(scope, iElement, iAttrs, controller) { 
            ...
            }).bind('hold click', function(e) {
                if(e.type == 'hold') {
                    touchDetected = true;

                    // callback (in parent scope)
                    ...
                    try {
                        ...
                        console.log(err, 'Do you have the needed directive in your view? Callback exists in you controller?');
                    }
